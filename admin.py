...
# Pega o arquivo
arquivo = getFile('databases/players_comp')
...
resetFile('databases/compressed_players')
resultList = []
...
writeBin(strbin, 'databases/compressed_players')

# Descomprimir
binarios = getBins('databases/compressed_players')
...
resetFile('databases/decompressed_players')
addToFile(result, 'databases/decompressed_players')
